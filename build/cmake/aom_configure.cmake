...
if(MSVC)
  ...
  add_compiler_flag_if_supported("-Wno-float-conversion")
  ...
  add_compiler_flag_if_supported("-DTORCH_MODELS_PATH=\\\"${CMAKE_TORCH_MODELS_PATH}\\\"")
  add_compiler_flag_if_supported("-I${CMAKE_PREFIX_PATH}/include")
endif()
