...
static const aom_cdf_prob default_cnn_guided_mode_cdf[CDF_SIZE(3)] = {
  AOM_CDF3(10813, 21626),
};
static const aom_cdf_prob default_cnn_guided_norestore_cdf[2][CDF_SIZE(2)] = {
  { AOM_CDF2(16384) }, { AOM_CDF2(24576) }
};  // intra 0.5 0.5 inter 0.75 0.25 TODO 修改默认分布

#if CONFIG_MY_GUIDED_USING_CODEBOOK

static const aom_cdf_prob default_intra_cnn_guided_codebook_cdf[QP_NUM][CODEBOOK_CHANNEL][CDF_SIZE(255)] = {
    {
        {26130, 20012, 15763, 12150, 9224, 6340, 4221, 2502, 1191, 448, 225, 114, 18, 1, 0, 0},
        {24831, 18970, 15338, 11885, 8526, 6995, 5465, 4258, 3131, 2271, 1532, 837, 156, 50, 4, 0},
        {22739, 14346, 10144, 7834, 5796, 4098, 2986, 2187, 1438, 909, 623, 347, 158, 5, 0, 0}
    },
    {
        {26901, 21117, 16276, 11868, 8159, 5940, 3890, 2873, 2206, 1577, 1052, 649, 326, 74, 18, 0},
        {23298, 18266, 13966, 10374, 7616, 5255, 4097, 2991, 2139, 1591, 1073, 684, 302, 34, 1, 0},
        {19521, 13367, 8419, 5940, 4000, 3192, 2416, 1752, 1140, 804, 527, 266, 110, 4, 0, 0}
    },
    {
        {26381, 20694, 15912, 11276, 7735, 5183, 3632, 2375, 1300, 784, 541, 299, 142, 11, 0, 0},
        {27383, 22538, 18552, 14575, 11308, 8182, 6145, 4146, 2728, 1737, 1027, 509, 241, 66, 1, 0},
        {21701, 16987, 12305, 8924, 6961, 5563, 4414, 3392, 2576, 1972, 1380, 950, 563, 234, 44, 0}
    },
    {
        {28272, 23850, 20052, 16452, 13118, 10187, 7283, 4487, 3278, 2126, 1130, 413, 168, 0, 0, 0},
        {27958, 23406, 19170, 15253, 11828, 8703, 6563, 4464, 2566, 1778, 1055, 458, 314, 179, 73, 0},
        {22629, 17292, 12460, 9687, 7499, 5536, 3796, 2935, 2326, 1740, 1214, 880, 546, 220, 0, 0}
    },
    {
        {27906, 23910, 20125, 16701, 13290, 10045, 7292, 4838, 2847, 1333, 268, 90, 50, 22, 0, 0},
        {27496, 22558, 18138, 14157, 11538, 8970, 7053, 5273, 3828, 2598, 1540, 627, 211, 46, 1, 0},
        {27282, 22011, 17735, 14157, 10759, 8022, 5871, 4483, 3347, 2445, 1612, 949, 297, 85, 0, 0}
    },
    {
        {29110, 25716, 22634, 19568, 16528, 13690, 11227, 8814, 6433, 4635, 3166, 1909, 822, 380, 116, 0},
        {28578, 24811, 21258, 17727, 14383, 11209, 8709, 6822, 4949, 3724, 2568, 1460, 700, 12, 3, 0},
        {27638, 23801, 20644, 17722, 14872, 12536, 10506, 8717, 7037, 5525, 4079, 2905, 1950, 1103, 460, 0}
    }
};

static const aom_cdf_prob default_intra_res_cnn_guided_codebook_cdf
    [QP_NUM][CODEBOOK_CHANNEL][CDF_SIZE(255)] = {
    {
        {27145, 22894, 18738, 14701, 10787, 6936, 3704, 1830, 847, 265, 175, 86, 17, 1, 0, 0},
        {26617, 21663, 17560, 13666, 10095, 6741, 4211, 3156, 2207, 1718, 1325, 946, 584, 312, 114, 0},
        {26661, 21057, 15689, 10957, 7019, 5322, 3701, 2424, 1823, 1388, 973, 591, 348, 140, 33, 0}
    },
    {
        {27473, 22428, 17521, 13456, 9932, 6796, 4187, 2015, 1062, 561, 356, 192, 107, 53, 1, 0},
        {25408, 20681, 16770, 12993, 9314, 5775, 2591, 1417, 1004, 650, 326, 99, 65, 31, 1, 0},
        {25734, 19776, 14348, 9286, 6591, 4254, 2788, 2184, 1608, 1133, 688, 292, 133, 11, 0, 0}
    },
    {
        {27227, 21782, 16691, 12818, 9092, 5831, 3515, 2194, 1075, 358, 185, 37, 0, 0, 0, 0},
        {24560, 19796, 15116, 10494, 6657, 2847, 2147, 1645, 1223, 834, 570, 353, 198, 126, 60, 0},
        {26355, 21022, 16509, 12080, 8402, 5557, 3416, 2513, 1866, 1258, 680, 357, 38, 19, 0, 0}
    },
    {
        {27750, 23410, 19180, 15091, 11195, 7321, 3642, 2022, 1460, 918, 587, 258, 32, 5, 0, 0},
        {27239, 21739, 16458, 12313, 8779, 5264, 3215, 1812, 897, 554, 352, 190, 31, 2, 0, 0},
        {25938, 21023, 16849, 12791, 9804, 7380, 5448, 3914, 2591, 1758, 1069, 683, 333, 149, 0, 0}
    },
    {
        {27563, 23599, 20228, 17021, 13883, 10898, 8011, 5641, 3545, 1700, 1069, 440, 194, 28, 0, 0},
        {27843, 23423, 19215, 15062, 10992, 7507, 4160, 2519, 1629, 1056, 535, 322, 117, 17, 1, 0},
        {28206, 24163, 20328, 16630, 13385, 10279, 7728, 6362, 5000, 3661, 2366, 1311, 827, 394, 0, 0}
    },
    {
        {25099, 19068, 13043, 9253, 5486, 3533, 1910, 600, 257, 87, 33, 0, 0, 0, 0, 0},
        {27958, 24036, 20415, 16815, 13828, 10953, 8115, 5683, 3536, 1459, 1045, 751, 478, 220, 4, 0},
        {28228, 24401, 20685, 17308, 14083, 11405, 8935, 6513, 4302, 2221, 936, 509, 268, 105, 0, 0}
    }
};

static const aom_cdf_prob
    default_inter_cnn_guided_codebook_cdf[QP_NUM][CODEBOOK_CHANNEL][CDF_SIZE(
        255)] = {
    {
        {27227, 22574, 18018, 13978, 10939, 8188, 6505, 5049, 3674, 2532, 1462, 656, 103, 10, 4, 0},
        {27753, 23107, 18665, 14496, 11119, 8050, 5029, 3761, 2655, 1958, 1323, 766, 463, 241, 30, 0},
        {25895, 20003, 15394, 11734, 8198, 4977, 3788, 2670, 1755, 963, 309, 172, 88, 16, 4, 0}
    },
    {
        {27945, 23733, 19744, 16108, 12495, 9243, 6812, 4450, 2717, 1131, 284, 61, 30, 12, 2, 0},
        {26928, 21691, 17412, 14219, 11394, 8608, 5875, 3210, 1867, 1207, 729, 384, 192, 6, 1, 0},
        {25933, 19213, 14128, 10957, 8183, 6369, 4682, 3289, 1903, 742, 511, 327, 161, 26, 0, 0}
    },
    {
        {27067, 22377, 17854, 14357, 11588, 9198, 6932, 4703, 3277, 2012, 1135, 328, 124, 12, 3, 0},
        {27171, 23125, 19325, 15534, 12089, 9386, 7421, 5641, 4010, 2487, 1459, 469, 168, 83, 7, 0},
        {25762, 20283, 16301, 12354, 8672, 6539, 4798, 3470, 2627, 1833, 1074, 412, 87, 19, 1, 0}
    },
    {
        {28459, 24323, 20285, 16384, 12769, 9399, 6879, 4739, 2749, 1938, 1155, 589, 285, 108, 20, 0},
        {28766, 24972, 21616, 18450, 15898, 13465, 11183, 8948, 6765, 4954, 3317, 2006, 1169, 541, 195, 0},
        {28301, 25321, 22401, 19900, 17525, 15246, 13016, 10804, 8774, 6751, 5117, 3635, 2401, 1347, 463, 0}
    },
    {
        {26696, 21263, 16905, 13545, 10200, 7223, 4472, 2934, 2015, 1185, 601, 306, 54, 10, 0, 0},
        {28726, 25236, 22098, 19518, 17025, 14549, 12104, 9901, 7893, 6136, 4435, 2747, 1631, 1032, 462, 0},
        {29498, 26418, 23423, 21041, 18677, 16336, 14143, 12030, 10006, 8143, 6311, 4578, 3409, 2241, 1092, 0}
    },
    {
        {28076, 23514, 19430, 15522, 12386, 9375, 6508, 4757, 3156, 1593, 964, 667, 413, 176, 1, 0},
        {28395, 24820, 21536, 18807, 16255, 13716, 11282, 8951, 6965, 5500, 4308, 3210, 2208, 1349, 516, 0},
        {29282, 25894, 22510, 19533, 16691, 14504, 12423, 10548, 8887, 7240, 5654, 4163, 2820, 1526, 384, 0}
    }
};

static const aom_cdf_prob default_inter_res_cnn_guided_codebook_cdf
    [QP_NUM][CODEBOOK_CHANNEL][CDF_SIZE(255)] = {
    {
        {27606, 22615, 18470, 14329, 10261, 6772, 4638, 2594, 1781, 1065, 694, 340, 7, 2, 0, 0},
        {27167, 22228, 17626, 13039, 8566, 5357, 2319, 1546, 824, 595, 426, 263, 168, 84, 22, 0},
        {27530, 22562, 17962, 14212, 10833, 7831, 5041, 3368, 2330, 1596, 1057, 629, 262, 83, 23, 0}
    },
    {
        {27351, 23598, 20046, 16522, 13123, 9967, 6862, 4213, 2604, 1416, 873, 391, 11, 0, 0, 0},
        {27411, 22558, 18075, 14025, 10318, 7303, 4766, 3631, 2503, 1431, 842, 536, 277, 101, 29, 0},
        {26513, 21705, 17944, 14381, 10912, 7480, 4913, 2810, 1705, 1036, 568, 221, 40, 18, 4, 0}
    },
    {
        {28696, 24997, 21368, 18137, 14914, 11812, 9006, 6445, 4173, 2590, 1459, 913, 371, 12, 3, 0},
        {26694, 21567, 16486, 12355, 8395, 4865, 3198, 2241, 1477, 764, 461, 160, 18, 5, 0, 0},
        {28163, 23580, 19688, 15922, 12694, 9754, 7174, 4649, 2523, 1440, 1027, 665, 370, 206, 88, 0}
    },
    {
        {28175, 23852, 19935, 16046, 12411, 9073, 6428, 4097, 2338, 1489, 800, 203, 69, 19, 1, 0},
        {26742, 21033, 16734, 12735, 10234, 7837, 6239, 4872, 3721, 2628, 1605, 884, 256, 15, 2, 0},
        {27838, 23351, 19344, 15478, 12234, 9502, 7335, 5964, 4600, 3303, 2346, 1464, 877, 304, 134, 0}
    },
    {
        {28082, 23580, 19581, 16182, 12801, 10112, 7588, 5484, 3435, 1458, 782, 169, 12, 1, 0, 0},
        {27230, 22363, 17940, 14421, 11453, 8616, 6610, 4821, 3087, 2277, 1592, 918, 546, 184, 52, 0},
        {28683, 24767, 21324, 18103, 15141, 12255, 10024, 7968, 5967, 4396, 3024, 1837, 1010, 597, 294, 0}
    },
    {
        {26999, 22273, 18158, 14405, 10680, 8651, 6782, 5093, 3943, 2807, 1833, 1266, 823, 509, 249, 0},
        {27092, 22442, 18047, 14999, 12351, 9743, 7268, 5637, 4226, 3117, 2010, 1312, 686, 340, 0, 0},
        {26484, 21563, 16769, 13756, 11786, 9864, 7948, 6468, 5127, 3941, 2847, 1870, 1146, 636, 279, 0}
    }
};
#endif
#endif
...
//   }
#if CONFIG_MY_GUIDED_CNN
  av1_copy(fc->cnn_guided_mode_cdf, default_cnn_guided_mode_cdf);
  av1_copy(fc->cnn_guided_norestore_cdf, default_cnn_guided_norestore_cdf);
#if CONFIG_MY_GUIDED_USING_CODEBOOK
  av1_copy(fc->intra_cnn_guided_codebook_cdf,
           default_intra_cnn_guided_codebook_cdf);
  av1_copy(fc->intra_res_cnn_guided_codebook_cdf,
           default_intra_res_cnn_guided_codebook_cdf);
  av1_copy(fc->inter_cnn_guided_codebook_cdf,
           default_inter_cnn_guided_codebook_cdf);
  av1_copy(fc->inter_res_cnn_guided_codebook_cdf,
           default_inter_res_cnn_guided_codebook_cdf);
#endif
#endif
...
#endif
#if CONFIG_MY_GUIDED_CNN
  AVERAGE_CDF(ctx_left->cnn_guided_mode_cdf, ctx_tr->cnn_guided_mode_cdf, 3);
...
void av1_setup_frame_contexts(AV1_COMMON *cm) {
  ...
  *cm->default_frame_context = *cm->fc;
  ...
  cm->buffer_pool_residue->frame_bufs[0].frame_context =
      *cm->fc;  // only 1 frame in residue pool
#endif
}
